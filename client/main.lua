...
RegisterNetEvent("fishing:tryToFish")
AddEventHandler("fishing:tryToFish", function()
	TryToFish() 
end)

RegisterNetEvent("fishing:calculatedistances")
AddEventHandler("fishing:calculatedistances", pos, function()
